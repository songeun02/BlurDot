...
if __name__ == '__main__':
    ...
    for k, image_path in enumerate(image_list):
        ...
        mask_file = os.path.join(result_folder, f"res_{model_name}_{refiner_suffix}_mask.jpg")
        ...
        file_utils.saveResult(
            ...
            dirname=os.path.join(result_folder, f"{model_name}_{refiner_suffix}")
        )
        ...
        # 블러링된 결과 이미지 저장
        blurred_file = os.path.join(result_folder, f"res_{k + 1}_blurred.jpg")
        ...
        """F1 SCORE 출력을 위해 새로 추가 """
        # 파일 경로
        detected_file = result_folder + '/craft_ic15_20k_res_img_17.txt'
        ground_truth_file = './text/gt_img_17.txt'
