...
def train(cfg):
	...
	for epoch in range(cfg.epoch_iter):	
		...
		for i, (img, gt_region, gt_affinity, conf_map) in enumerate(train_loader):
			...
			# print("gt_region shape:", gt_region.shape)
			# print("pred_region shape:", pred_region.shape)
			# print("gt_affinity shape:", gt_affinity.shape)
			# print("pred_affinity shape:", pred_affinity.shape)
			# print("conf_map shape:", conf_map.shape)
